...
using MySettings = StructuredFileDataSourceSettings<WindCubeSettings, WindCubeAdditionalFileSourceSettings>;
...
public class WindCubeTests
{
    ...
    {
        // arrange
        var dataSource = (IDataSource<MySettings>)new WindCube();
